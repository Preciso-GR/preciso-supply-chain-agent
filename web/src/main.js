...
function renderHome() {
  return `
    <main class="site-shell home-shell">
      ...
      <header class="site-nav glass-panel">
        <button class="brand" data-action="home" aria-label="SATURN home">
          <span class="brand-mark">S</span>
          <span class="brand-copy"><strong>SATURN</strong><small>powered by PRECISO</small></span>
        </button>
        <nav class="nav-links" aria-label="Primary navigation">
          <a href="#product">Product</a><a href="#workflow">How it works</a><a href="#evidence">Evidence</a>
        </nav>
        <div class="nav-actions"><button class="text-button" data-action="workspace">Sign in</button><button class="small-cta" data-action="workspace">Open center <span>↗</span></button></div>
      </header>
      ...
      <section class="hero" id="product">
        <div class="hero-copy">
          ...
          <p class="hero-lede">SATURN turns messy supply-chain documents into a living, reviewable map of facilities, components, and products — with every answer anchored to source evidence.</p>
        ...
        <div class="hero-visual" aria-label="Orbital SATURN mark">
          <div id="saturn-orbit-scene" class="orbit-scene" role="img" aria-label="Animated three-dimensional SATURN orbital system"></div>
          <div class="orbit-caption"><span class="pulse"></span><span>Northbridge snapshot</span><strong>01.15.26</strong></div>
        </div>
      </section>

      <section class="ticker" aria-label="SATURN capabilities"><span>FACILITY GRAPH</span><i></i><span>DOCUMENT EXTRACTION</span><i></i><span>DEPENDENCY PATHS</span><i></i><span>TRACEABLE EVIDENCE</span></section>

      <section class="feature-section" id="workflow">
        <div class="section-heading"><p class="eyebrow">One center, three moves</p><h2>From source files<br /><span>to confident action.</span></h2><p>Keep the analyst in control. SATURN shows what it found, what supports it, and what still needs a human call.</p></div>
        <div class="feature-grid">
          <article class="feature-card feature-card-large"><div class="feature-number">01</div><div><p class="card-label">BUILD THE GRAPH</p><h3>Bring your documents.<br />Leave with structure.</h3><p>Upload facility registers, bills of material, and identity notices. SATURN proposes entities and relationships without hiding the raw source.</p><button class="inline-link" data-action="workspace">Open a center <span>→</span></button></div><div class="mini-graph"><span class="node node-a">Facility</span><span class="connector connector-one"></span><span class="node node-b">Component</span><span class="connector connector-two"></span><span class="node node-c">Product</span></div></article>
      ...
      <footer class="site-footer"><div class="brand-copy"><strong>SATURN</strong><small>powered by PRECISO</small></div><p>Supply chain intelligence you can stand behind.</p><span>© 2026 SATURN</span></footer>
    </main>
  `
}
    ...
    <main class="workspace-shell">
      ...
      <div class="workspace-layout ${state.inspectorOpen ? '' : 'no-inspector'}">
        ...
        <section class="chat-column">
          <div class="chat-scroll"><div class="conversation-intro"><div class="saturn-avatar">S</div><div><p class="eyebrow">SATURN ANALYST</p><h1>Northbridge resilience review</h1><p>Ask about documented dependencies, review extracted facts, or run a facility scenario. This workspace is fixture-backed for now.</p></div></div>
          ...
          <form class="composer" id="composer"><button type="button" class="composer-plus" title="Attach documents">＋</button><input name="message" autocomplete="off" placeholder="Ask about your dependencies…" aria-label="Ask SATURN" /><button class="composer-send" type="submit" aria-label="Send message">↑</button><div class="composer-hint">Fixture mode · Enter to send</div></form>
        </section>
